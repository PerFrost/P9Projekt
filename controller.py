...
if __name__ == '__main__':
    ...
    while True:
        ...
        if frame is not None:
            ...
            hand_landmarks_list = newFrame.multi_hand_landmarks

            if hand_landmarks_list and len(hand_landmarks_list[0].landmark) > 8:
                tip_of_index_finger = hand_landmarks_list[0].landmark[8]
